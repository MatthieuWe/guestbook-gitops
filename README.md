...
│   ├── 🌐 Domain: guestbook-mw.duckdns.org
│   ├── 🔄 Auto-renewal: Yes
...
```
1. 🌐 User visits https://guestbook-mw.duckdns.org/
...
- DNS record pointing `guestbook-mw.duckdns.org` to your cluster
...
2. **Update Repository Name in kustomization.yaml**:
   ...
   # Change: ghcr.io/matthieuwe/guestbook-gitops
   ```
